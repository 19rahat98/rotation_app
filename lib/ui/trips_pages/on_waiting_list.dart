...
class OnWaitingListWidget extends StatelessWidget {
  final Application tripData;

  OnWaitingListWidget({Key key, this.tripData}) : super(key: key);
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Тайм-лимит оформления: до 5 фев, 19:00**',
                            style: TextStyle(
                              fontFamily: "Root",
                              fontSize: 14,
                              fontWeight: FontWeight.w500,
...
class OnWaitingListTripSheet extends StatefulWidget {
  final Application tripData;

  const OnWaitingListTripSheet({Key key, this.tripData}) : super(key: key);

  @override
  _OnWaitingListTripSheetState createState() => _OnWaitingListTripSheetState();
}

class _OnWaitingListTripSheetState extends State<OnWaitingListTripSheet> {
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'Поездка находится в листе ожидания.  Тайм-лимит оформления: до 5 фев, 19:00**',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                        fontSize: 15,
